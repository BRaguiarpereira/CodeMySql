drop database BD_TESTEbrian_aguiar_pereira;
...
sim poderia melhorar anexando o COD_TIPOCLIENTE na tabela CLIENTE assim vinculando o tipo do cliente diretamente a ela .
